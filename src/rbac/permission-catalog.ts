...
export const PERMISSION_DEFINITIONS: readonly PermissionDefinition[] = [
  ...
  },
  {
    ...
    description: 'View service catalog entries in the tenant',
  },
  {
    key: PERMISSIONS.SERVICE_CREATE,
    name: 'Create services',
    category: PERMISSION_CATEGORIES.SERVICES,
    description: 'Create service catalog entries in the tenant',
  },
  {
    ...
    category: PERMISSION_CATEGORIES.SERVICES,
    description:
      'Update and archive service catalog entries in the tenant (catalog definition only — no booking, scheduling, pricing, or assignment)',
  },
  {
    key: PERMISSIONS.BOOKING_READ,
    name: 'Read bookings',
    category: PERMISSION_CATEGORIES.BOOKINGS,
    description: 'View service bookings in the tenant',
  },
  {
    key: PERMISSIONS.BOOKING_CREATE,
    name: 'Create bookings',
    category: PERMISSION_CATEGORIES.BOOKINGS,
    description: 'Create service bookings in the tenant',
  },
  {
